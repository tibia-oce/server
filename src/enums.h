...
enum LootCategory_t
{
	LOOT_CATEGORY_NONE = 1 << 0,             // 1  (00000001)
	LOOT_CATEGORY_GOLD = 1 << 1,             // 2  (00000010)
	LOOT_CATEGORY_VALUABLES = 1 << 2,        // 4  (00000100)
	LOOT_CATEGORY_EQUIPMENT = 1 << 3,        // 8  (00001000)
	LOOT_CATEGORY_POTIONS = 1 << 4,          // 16 (00010000)
	LOOT_CATEGORY_AMMUNITION = 1 << 5,       // 32 (00100000)
	LOOT_CATEGORY_CREATURE_PRODUCTS = 1 << 6,// 64 (01000000)
	LOOT_CATEGORY_FOOD = 1 << 7,             // 128(10000000)
	LOOT_CATEGORY_SPECIAL = 1 << 8,          // 256
	LOOT_CATEGORY_MISC = 1 << 9              // 512
};
...
enum itemAttrTypes : uint32_t {
    ...
    ITEM_ATTRIBUTE_LOOTCATEGORY = 1 << 30,
    ITEM_ATTRIBUTE_RARITY = 1U << 31,
    
    // todo(itemattr): special value for CUSTOM that doesn't rely on bit shifting
    // using a value that would be 1ULL << 32 but represented differently
    ITEM_ATTRIBUTE_CUSTOM = 0
};
...
enum ConditionParam_t {
	...
	// todo(skills)
	CONDITION_PARAM_SKILL_MINING = 56,
    CONDITION_PARAM_SKILL_MININGPERCENT = 57,
    CONDITION_PARAM_SKILL_WOODCUTTING = 58,
    CONDITION_PARAM_SKILL_WOODCUTTINGPERCENT = 59,
    CONDITION_PARAM_SKILL_HERBALISM = 60,
    CONDITION_PARAM_SKILL_HERBALISPERCENT = 61,
    CONDITION_PARAM_SKILL_CRAFTING = 62,
    CONDITION_PARAM_SKILL_CRAFTINGPERCENT = 63,
    CONDITION_PARAM_SKILL_ENCHANTING = 64,
    CONDITION_PARAM_SKILL_ENCHANTINGPERCENT = 65,
    CONDITION_PARAM_SKILL_DISENCHANTING = 66,
    CONDITION_PARAM_SKILL_DISENCHANTINGPERCENT = 67,
};
...
enum skills_t : uint8_t {
    ...
    SKILL_CRAFTING = 10,
    SKILL_ENCHANTING = 11,
    SKILL_DISENCHANTING = 12,
    SKILL_MAGLEVEL = 13,
    SKILL_LEVEL = 14,
    SKILL_FIRST = SKILL_FIST,
    SKILL_LAST = SKILL_DISENCHANTING
};
