...
enum ImbuementType : uint8_t {
    ...
    IMBUEMENT_TYPE_MINING_SKILL,
    IMBUEMENT_TYPE_WOODCUTTING_SKILL,
    IMBUEMENT_TYPE_HERBALISM_SKILL,
    IMBUEMENT_TYPE_CRAFTING_SKILL,
    IMBUEMENT_TYPE_ENCHANTING_SKILL,
    IMBUEMENT_TYPE_DISENCHANTING_SKILL,
