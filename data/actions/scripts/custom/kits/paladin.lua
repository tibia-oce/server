function onUse(player, item, fromPosition, target, toPosition)
    ...
    if vocation == VOCATION.ID.PALADIN then
        local rewards = {
            {2160, 100}, -- 100 crystal coins
            {28133, 1}, -- bug-blaster quiver
            {28132, 1}, -- bug-blaster bow
            {2504, 1}, -- dwarven legs
        ...
        doPlayerSetSkillLevel(player, SKILL_MAGLEVEL, 15)
        doPlayerSetSkillLevel(player, SKILL_DISTANCE, 80)
