-- Version: 8.50
-- Monster: https://tibia.fandom.com/wiki/Evil_Sheep_Lord
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Evil_Sheep_Lord
---
...
monster.loot = {
	{ id = "gold coin", chance = 79926, minCount = 1, maxCount = 60 },  -- 2148
}
