local mType = Game.createMonsterType("King Aldor Goldcrusher")
local monster = {}

monster.description = "a King Aldor Goldcrusher"
...
local combat = Combat()
combat:setParameter(COMBAT_PARAM_EFFECT, 265)
combat:setParameter(COMBAT_PARAM_TYPE, COMBAT_FIREDAMAGE)
combat:setParameter(COMBAT_PARAM_DISTANCEEFFECT, 26)
combat:setArea(createCombatArea(AREA_CUSTOM_11))
...
local function performAttack(monster, targetCreature)
    local damage = math.random(2500, 5000)
