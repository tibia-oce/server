local mType = Game.createMonsterType("Grimnir Slashbaiter")
local monster = {}

monster.description = "a Grimnir Slashbaiter"
...
local combat = Combat()
combat:setParameter(COMBAT_PARAM_EFFECT, 290)
...
local function performAttack(monster, targetCreature)
    local damage = math.random(1350, 2450)
