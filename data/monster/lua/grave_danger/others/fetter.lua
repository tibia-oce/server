...
monster.defenses = {
	defense = 35,
	armor = 35,
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HEALING, minDamage = 100, maxDamage = 700, effect = 185, target = false},
	{name = "speed", chance = 15, interval = 2*1000, speed = 290, effect = CONST_ME_MAGIC_RED}
}
