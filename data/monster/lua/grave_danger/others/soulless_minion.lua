...
monster.attacks = {
	...
	{name = "speed", chance = 15, interval = 2*1000, speed = -400, radius = 3, target = true, duration = 30*1000, effect = CONST_ME_MAGIC_RED},
}

monster.defenses = {
	defense = 30,
	armor = 30,
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_HEALING, minDamage = 15, maxDamage = 25, effect = 185, target = false}
}
