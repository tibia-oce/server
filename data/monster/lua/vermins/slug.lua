-- Version: 9.10
-- Monster: https://tibia.fandom.com/wiki/Slug
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Slug
---
...
monster.loot = {
	{ id = "gold coin", chance = 62600, minCount = 1, maxCount = 40 },  -- 2148
	{ id = "worm", chance = 4918, minCount = 1, maxCount = 3 },  -- 3976
}
