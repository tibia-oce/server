...
monster.loot = {
	{ id = "gold coin", chance = 89700, minCount = 1, maxCount = 119 },  -- 2148
	{ id = "spider fangs", chance = 25090 },  -- 8859
	{ id = "scarab coin", chance = 6723, minCount = 1, maxCount = 4 },  -- 2159
	{ id = "plate armor", chance = 4754 },  -- 2463
	{ id = "gold ingot", chance = 60 },  -- 9971
}
