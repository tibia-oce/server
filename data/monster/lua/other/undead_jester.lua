...
monster.attacks = {
	...
	{name ="drunk", interval = 1000, chance = 20, drunkenness = 25, duration = 10000, range = 7, radius = 1, target = true, shootEffect = CONST_ANI_ENERGY}
}
...
monster.summons = {
	{name = "cave rat", chance = 10, interval = 2000, max = 4}
}
