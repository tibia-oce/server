-- Version: 8.40
-- Monster: https://tibia.fandom.com/wiki/Diseased_Dan
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Diseased_Dan
---
...
monster.loot = {
	{ id = "gold coin", chance = 38710, minCount = 1, maxCount = 25 },  -- 2148
}
...
monster.defenses = {
	...
	armor = 10,
	--	mitigation = ???,
	{ name = "speed", interval = 10000, chance = 40, effect = CONST_ME_MAGIC_GREEN, speed = 150},
