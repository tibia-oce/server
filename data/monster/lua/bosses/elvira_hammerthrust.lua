-- Version: 9.40
-- Monster: https://tibia.fandom.com/wiki/Elvira_Hammerthrust
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Elvira_Hammerthrust
---
...
monster.loot = {
	...
	{ id = "platinum coin", chance = 100000, minCount = 16, maxCount = 96 },  -- 2152
}
