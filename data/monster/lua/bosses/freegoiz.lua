-- Version: --
-- Monster: https://tibia.fandom.com/wiki/Freegoiz
---
-- Freegoiz (Tibia Wiki: https://tibia.fandom.com/wiki/Freegoiz)
-- Version: --
...
monster.defenses = {
	...
	{ name = "speed", interval = 2000, chance = 8, effect = CONST_ME_MAGIC_RED, speed = 380},
}
