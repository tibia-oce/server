...
monster.attacks = {
	...
	{ name = "speed", interval = 1000, chance = 12, speed = -1900, radius = 6, effect = CONST_ME_POISONAREA, target = false, duration = 60000 },
...
monster.defenses = {
	...
	{ name = "speed", interval = 1000, chance = 8, effect = CONST_ME_MAGIC_RED, speed = 530},
