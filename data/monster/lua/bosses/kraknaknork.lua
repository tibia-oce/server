-- Version: 9.10
-- Monster: https://tibia.fandom.com/wiki/Kraknaknork
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Kraknaknork
---
...
monster.loot = {
	{ id = "gold coin", chance = 95455, minCount = 1, maxCount = 15 },  -- 2148
}
