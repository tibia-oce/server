-- Wrath of the Emperor (Tibia Wiki: https://tibia.fandom.com/wiki/Wrath_of_the_Emperor)
-- Version: 8.60
...
monster.attacks = {
	...
	{ name = "speed", interval = 1000, chance = 10, speed = -600, range = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 20000 },
