-- Version: 8.20
-- Monster: https://tibia.fandom.com/wiki/The_Weakened_Count
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:The_Weakened_Count
---
...
monster.loot = {
	...
	{ id = "gold coin", chance = 75000, minCount = 3, maxCount = 98 },  -- 2148
}
