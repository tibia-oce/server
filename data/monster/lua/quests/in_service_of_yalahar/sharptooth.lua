-- Version: 8.40
-- Monster: https://tibia.fandom.com/wiki/Sharptooth
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Sharptooth
---
...
monster.loot = {
	{ id = "fishbone", chance = 27778 },  -- 2226
	{ id = "gold coin", chance = 5556, maxCount = 6 },  -- 2148
}
