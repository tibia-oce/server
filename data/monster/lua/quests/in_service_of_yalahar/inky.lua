-- Version: 8.40
-- Monster: https://tibia.fandom.com/wiki/Inky
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Inky
---
...
monster.loot = {
	{ id = "gold coin", chance = 12500, minCount = 3, maxCount = 10 },  -- 2148
}
