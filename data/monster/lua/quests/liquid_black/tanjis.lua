...
monster.loot = {
	{ id = "depth ocrea", chance = 52214 },  -- 15409
	{ id = "ornate mace", chance = 26107 },  -- 15414
	{ id = "ornate shield", chance = 21678 },  -- 15413
}
...
monster.attacks = {
	...
	{ name = "speed", interval = 2150, chance = 16, speed = -600, range = 7, radius = 1, target = true, duration = 15000 },
}
