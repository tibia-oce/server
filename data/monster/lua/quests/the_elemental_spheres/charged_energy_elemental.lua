-- Version: 8.20
-- Monster: https://tibia.fandom.com/wiki/Charged_Energy_Elemental
-- Loot table: https://tibia.fandom.com/wiki/Loot_Statistics:Charged_Energy_Elemental
---
...
monster.loot = {
	{ id = "gold coin", chance = 74114, minCount = 1, maxCount = 122 },  -- 2148
	{ id = "energy soil", chance = 6934 },  -- 8303
	{ id = "flash arrow", chance = 4160, minCount = 1, maxCount = 3 },  -- 7838
}
