local mType = Game.createMonsterType("Signatus")
local monster = {}

monster.description = "a Signatus"
...
monster.defenses = {
	defense = 55,
	armor = 55,
	{name ="combat", interval = 3000, chance = 10, type = COMBAT_HEALING, minDamage = 600, maxDamage = 600, effect = 185, target = false},
}
