...
function getPlayerDatabaseInfo(name_or_guid)
	...
	local info = {
        ...
        ["skill_herbalism"] = result.getNumber(query, "skill_herbalism"),
        ["skill_crafting"] = result.getNumber(query, "skill_crafting"),
        ["skill_enchanting"] = result.getNumber(query, "skill_enchanting"),
        ["skill_disenchanting"] = result.getNumber(query, "skill_disenchanting"),
